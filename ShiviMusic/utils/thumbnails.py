...
def _sunburst_thumb(
    ...
    # Fonts
    try:
        f_title   = ImageFont.truetype("ShiviMusic/assets/font.ttf",  82)
        f_channel = ImageFont.truetype("ShiviMusic/assets/font.ttf",  40)
        f_meta    = ImageFont.truetype("ShiviMusic/assets/font.ttf",  34)
        f_time    = ImageFont.truetype("ShiviMusic/assets/font2.ttf", 30)
    except Exception:
...
def _hexagon_thumb(
    ...
    # Fonts
    try:
        f_title = ImageFont.truetype("ShiviMusic/assets/font.ttf",  44)
        f_meta  = ImageFont.truetype("ShiviMusic/assets/font.ttf",  26)
        f_tag   = ImageFont.truetype("ShiviMusic/assets/font2.ttf", 28)
    except Exception:
