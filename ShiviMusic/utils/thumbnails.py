...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("ShiviMusic/assets/assets/font2.ttf", 30)
    font = ImageFont.truetype("ShiviMusic/assets/assets/font.ttf", 30)
    ...
    play_icons = Image.open("ShiviMusic/assets/assets/play_icons.png")
