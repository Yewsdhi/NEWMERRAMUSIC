...
async def locktypes_handler(_, message: Message):
    ...
    descriptions = {
        "all": "<b>ʙʟᴏᴄᴋs ᴀʟʟ ᴍᴇssᴀɢᴇs</b>",
        "audio": "<b>ʙʟᴏᴄᴋs ᴀᴜᴅɪᴏ ꜰɪʟᴇs</b>",
        "bots": "<b>ʙʟᴏᴄᴋs ʙᴏᴛ ᴀᴅᴅɪᴛɪᴏɴs & ʀᴇᴍᴏᴠᴇs ᴛʜᴇᴍ ᴡɪᴛʜ ᴡᴀʀɴɪɴɢs</b>",
        "button": "<b>ʙʟᴏᴄᴋs ᴍᴇssᴀɢᴇs ᴡɪᴛʜ ɪɴʟɪɴᴇ ʙᴜᴛᴛᴏɴs</b>",
        "contact": "<b>ʙʟᴏᴄᴋs ᴄᴏɴᴛᴀᴄᴛ sʜᴀʀɪɴɢ</b>",
        "document": "<b>ʙʟᴏᴄᴋs ᴅᴏᴄᴜᴍᴇɴᴛ ꜰɪʟᴇs</b>",
        "egame": "<b>ʙʟᴏᴄᴋs ᴇᴍʙᴇᴅᴅᴇᴅ ɢᴀᴍᴇs</b>",
        "forward": "<b>ʙʟᴏᴄᴋs ꜰᴏʀᴡᴀʀᴅᴇᴅ ᴍᴇssᴀɢᴇs</b>",
        "game": "<b>ʙʟᴏᴄᴋs ɢᴀᴍᴇs</b>",
        "gif": "<b>ʙʟᴏᴄᴋs ɢɪꜰ ᴀɴɪᴍᴀᴛɪᴏɴs</b>",
        "info": "<b>ʙʟᴏᴄᴋs sᴇʀᴠɪᴄᴇ ᴍᴇssᴀɢᴇs</b>",
        "inline": "<b>ʙʟᴏᴄᴋs ɪɴʟɪɴᴇ ʙᴏᴛ ʀᴇsᴜʟᴛs</b>",
        "invite": "<b>ʙʟᴏᴄᴋs ɪɴᴠɪᴛᴇ ʟɪɴᴋs</b>",
        "location": "<b>ʙʟᴏᴄᴋs ʟᴏᴄᴀᴛɪᴏɴ/ᴠᴇɴᴜᴇ sʜᴀʀɪɴɢ</b>",
        "media": "<b>ʙʟᴏᴄᴋs ᴀʟʟ ᴍᴇᴅɪᴀ ᴛʏᴘᴇs</b>",
        "messages": "<b>ʙʟᴏᴄᴋs ᴛᴇxᴛ ᴍᴇssᴀɢᴇs</b>",
        "other": "<b>ʙʟᴏᴄᴋs ᴏᴛʜᴇʀ ᴄᴏɴᴛᴇɴᴛ ᴛʏᴘᴇs</b>",
        "photo": "<b>ʙʟᴏᴄᴋs ᴘʜᴏᴛᴏs/ɪᴍᴀɢᴇs</b>",
        "pin": "<b>ʙʟᴏᴄᴋs ᴘɪɴɴᴇᴅ ᴍᴇssᴀɢᴇs</b>",
        "poll": "<b>ʙʟᴏᴄᴋs ᴘᴏʟʟs</b>",
        "previews": "<b>ʙʟᴏᴄᴋs ʟɪɴᴋ ᴘʀᴇᴠɪᴇᴡs</b>",
        "rtl": "<b>ʙʟᴏᴄᴋs ʀᴛʟ ᴛᴇxᴛ</b>",
        "sticker": "<b>ʙʟᴏᴄᴋs sᴛɪᴄᴋᴇʀs</b>",
        "url": "<b>ʙʟᴏᴄᴋs ᴜʀʟs/ʟɪɴᴋs</b>",
        "username": "<b>ʙʟᴏᴄᴋs ᴜsᴇʀɴᴀᴍᴇ ᴍᴇɴᴛɪᴏɴs (@username)</b>",
        "video": "<b>ʙʟᴏᴄᴋs ᴠɪᴅᴇᴏs</b>",
        "voice": "<b>ʙʟᴏᴄᴋs ᴠᴏɪᴄᴇ ᴍᴇssᴀɢᴇs</b>"
    }
